...
//
  ...
  `define E203_DECINFO_ALU_WFI   `E203_DECINFO_ALU_WFI_MSB:`E203_DECINFO_ALU_WFI_LSB
      `define E203_DECINFO_ALU_IBUTTERFLY_LSB  (`E203_DECINFO_ALU_WFI_MSB+1)
	  `define E203_DECINFO_ALU_IBUTTERFLY_MSB  (`E203_DECINFO_ALU_IBUTTERFLY_LSB+1-1)
  `define E203_DECINFO_ALU_IBUTTERFLY `E203_DECINFO_ALU_IBUTTERFLY_MSB : `E203_DECINFO_ALU_IBUTTERFLY_LSB
	  `define E203_DECINFO_ALU_NSWAPLL_LSB    (`E203_DECINFO_ALU_IBUTTERFLY_MSB+1)
	  `define E203_DECINFO_ALU_NSWAPLL_MSB    (`E203_DECINFO_ALU_NSWAPLL_LSB+1-1)
  `define E203_DECINFO_ALU_NSWAPLL    `E203_DECINFO_ALU_NSWAPLL_MSB : `E203_DECINFO_ALU_NSWAPLL_LSB
	  `define E203_DECINFO_ALU_NSWAPHL_LSB    (`E203_DECINFO_ALU_NSWAPLL_MSB+1)
	  `define E203_DECINFO_ALU_NSWAPHL_MSB    (`E203_DECINFO_ALU_NSWAPHL_LSB+1-1)
   `define E203_DECINFO_ALU_NSWAPHL   `E203_DECINFO_ALU_NSWAPHL_MSB : `E203_DECINFO_ALU_NSWAPHL_LSB
	  `define E203_DECINFO_ALU_NSWAPLH_LSB    (`E203_DECINFO_ALU_NSWAPHL_MSB+1)
	  `define E203_DECINFO_ALU_NSWAPLH_MSB    (`E203_DECINFO_ALU_NSWAPLH_LSB+1-1)
   `define E203_DECINFO_ALU_NSWAPLH   `E203_DECINFO_ALU_NSWAPLH_MSB : `E203_DECINFO_ALU_NSWAPLH_LSB
	  `define E203_DECINFO_ALU_NSWAPHH_LSB    (`E203_DECINFO_ALU_NSWAPLH_MSB+1)
	  `define E203_DECINFO_ALU_NSWAPHH_MSB    (`E203_DECINFO_ALU_NSWAPHH_LSB+1-1)
   `define E203_DECINFO_ALU_NSWAPHH   `E203_DECINFO_ALU_NSWAPHH_MSB : `E203_DECINFO_ALU_NSWAPHH_LSB

  `define E203_DECINFO_ALU_WIDTH    (`E203_DECINFO_ALU_NSWAPHH_MSB+1)
