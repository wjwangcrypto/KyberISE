...
/*add*/
extern void polyAdd(int16_t *, int16_t *, int16_t *);
extern void polySub(int16_t *, int16_t *, int16_t *);
...
/*add*/
#define poly_basemul_montgomery_add KYBER_NAMESPACE(_poly_basemul_montgomery_add)
void poly_basemul_montgomery_add(poly *r, const poly *a, const poly *b);
