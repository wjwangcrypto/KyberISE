...
*/
  ...
  /*for(i=0;i<KYBER_K;i++){
    printf("after_polyvec_pointwise_bp[%d] = ",i);
    for(int j=0; j<KYBER_N; j++){
      printf("%d,",bp.vec[i].coeffs[j]);
    }
    printf("\n");
  }
  printf("\n");
*/
  ...
  /*printf("after_polyvec_pointwise_v:");
  for(i=0; i<KYBER_N; i++){
    printf("%d,",v.coeffs[i]);
  }
  printf("\n");
...
*/
  ...
  //end_enc_part2 = __get_rv_cycle();
  //printf("enc_part2 = %d\n", end_enc_part2 - begin_enc_part2);
}
